    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a href='https://x.com/code_aman1' target={"_black"}
            whileHover={{ y: -3 }}
            whileTap={{ scale: 1.2 }}
            className="w-8 mx-3"
          >
          ...
          <motion.a href='https://github.com/AtaAman' target={"_black"}
            className="w-8 mx-3"
            whileHover={{ y: -3 }}
            whileTap={{ scale: 1.2 }}
          >
          ...
          <motion.a href='https://www.linkedin.com/in/md-aman-ata-b9bb361bb/' target={"_black"}
            className="w-7 mx-3"
            whileHover={{ y: -3 }}
            whileTap={{ scale: 1.2 }}
          >
        ...
        isOpen ?
          ...
          <motion.div
            ...
            <nav className="flex items-center justify-center flex-wrap mt-2">
              <motion.a href='https://twitter.com/code_aman1' target={"_black"}
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.9 }}

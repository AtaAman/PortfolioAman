...
const Skills =({name, x, y}) => {
  return (
    <>
    <h2 className="font-bold text-6xl mt-32 w-full text-center md:text-6xl sm:text-4xl mb-20">Skills</h2>
    ...
    ">
      ...
      <Skill name="Git" x="0vw" y="11vw" />

      <Skill name="Next.js" x="-24vw" y="-17vw" />
      ...
      <Skill name="Express.js" x="18vw" y="-15vw" />
